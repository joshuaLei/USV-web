...
<!-- Navbar -->
<div class="navbar">
	<a href="manual.html" class="title">USV_0<?= $usv ?></a>
	<ul class="nav_L">
...
<div class="images">
	...
	<div id="frame4">
		<img id="camera4" src="images/frame2.jpg" alt="Please check your connection"/>
	</div>
</div>
...
<div class="control_panel">
	...
	<div class="button_top">
		<a class="button_list_item" href="#" onclick="onclick_light(event)">
			<i class="fa fa-lightbulb-o w3-xxlarge"></i>
			<h8><center>Light</center></h8>
		</a>		
		
		<a class="button_list_item" href="#" onclick="onclick_speaker(event)">
			<i class="fa fa-volume-up  w3-xxlarge"></i>
			<h8><center>Speaker</center></h8>
		</a>	

		<a class="button_list_item" href="#" onclick="onclick_alarm(event)">
	...
	<div class="button_bottom">
		<a class="button_list_item" href="#" onclick="onclick_start(event)">
			<i class="fa fa-play w3-xxlarge"></i>
			<h8><center>Start</center></h8>
		</a>		
		
		<a class="button_list_item" href="#">
			<i class="fa fa-cog w3-xxlarge"></i>
			<h8><center>...</center></h8>
		</a>	

		<a class="button_list_item" href="#" onclick="onclick_stop(event)">
			<i class="fa fa-stop w3-xxlarge"></i>
	...
	<div class="sensor_value">
		...
		<div class="sensor">
			<i class="fa fa-compass w3-large""></i><span class="value" id="gpsY" style="margin-left:5px">Y2: 190.96</span>
		</div>
	</div>
</div>
